<?php
include('/Users/tuukka/work/conjugation/tools/conv.php');

use Conjugation\Noun;
use PHPUnit\Framework\TestCase;

class NewNounTest extends TestCase
{
...
//            "kampi" => "kammen",
        ...
        $noun = new Noun(true);
        $c = file_get_contents("/Users/tuukka/work/conjugation/tools/jouka.log");

        $word = "käpy";
        $correct_answer = "kävyn";
        $actual = $noun->genitive($word);
        $this->assertEquals($correct_answer, $actual["answer"]);
        $geb = inflectWord($word, "subst-" . doMatch($word, $c));
        $this->assertEquals($correct_answer, $geb);
